...
import pexpect
from baresipy import LOG, BareSIP
            ...
            try:
                ...
                if out != self._prev_output:
                    ...
                    if "baresip is ready." in out:
                        ...
                        self.em.emit(
                            "incoming_call", num=num, raw=out, bs_instance=self
                        )
                        ...
                        self.em.emit(
                            "rejecting_call", num=num, raw=out, bs_instance=self
                        )
                        ...
                        self.mic_muted = False
                        self.em.emit(
                            "session_closed", reason=reason, raw=out, bs_instance=self
                        )
